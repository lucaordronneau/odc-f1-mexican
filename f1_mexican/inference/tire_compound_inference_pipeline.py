...
class TireCompoundInferencePipeline:
    ...
    def compute_driver_statistics(self, driver, grid_position, stint_number, predicted_stint_number, previous_compound, MaxNumber):
    ...
    def predict_compounds(self, driver, grid_position, predicted_stint_number, MaxNumber):
        predicted_compounds = []
        previous_compound = [0.0, 0.0]
        ...
        for stint_number in range(1, predicted_stint_number + 1):
            ...
            features = self.compute_driver_statistics(
                driver, grid_position, stint_number, predicted_stint_number, previous_compound, MaxNumber
            )

            # Convert features to DataFrame
            feature_columns = ['Year', 'CumulativePoints', 'WeightedCumulativeMeanLapTimeSeconds', 'WeightedCumulativeMeanLapDeltaSeconds', 'WeightedCumulativeMeanFinalPosition', 'WeightedCumulativeMeanLapPosition', 'WeightedCumulativeMeanGridPosition', 'GridPosition', 'WeightedCumulativeMeanSpeedI1', 'WeightedCumulativeMeanSpeedI2', 'WeightedCumulativeMeanSpeedFL', 'WeightedCumulativeMeanSpeedST', 'NumberOfRacesOnStint', 'RaceNumber', 'Stint', 'StintNumber', 'MaxNumber', 'GridPositionEmbedding_0', 'GridPositionEmbedding_1', 'WeightedCumulativeMeanCompoundEmbeddings_0', 'WeightedCumulativeMeanCompoundEmbeddings_1', 'TeamEmbeddings_0', 'TeamEmbeddings_1', 'DriverEmbeddings_0', 'DriverEmbeddings_1', 'EventNameEmbeddings_0', 'EventNameEmbeddings_1', 'ShiftedCompoundEmbedding_0', 'ShiftedCompoundEmbedding_1']
            ...
            # Make prediction
            compound_encoded = self.loaded_model.predict(feature_df_scaled)
            tmp = self.loaded_model.predict_proba(feature_df_scaled)

            compound = self.label_encoder.inverse_transform(compound_encoded)[0]

            predicted_compounds.append(compound)
            ...
            previous_compound = tyre_compounds_embeddings_tmp[compound]  # Update previous compound for the next stint
