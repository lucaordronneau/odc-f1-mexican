...
class StintNumberModelTrainingPipeline:
    def __init__(self, df):
        self.df = df
        self.embedding_columns = [
            'GridPositionEmbedding', 'WeightedCumulativeMeanCompoundEmbeddings', 
            'TeamEmbeddings', 'DriverEmbeddings', 'EventNameEmbeddings'
        ]
        self.target = 'StintNumber'
        self.model = None
        self.scaler = None
    ...
    def run(self):
        ...
        self.save_model('models/final_stint_number_xgboost_model.pkl')
